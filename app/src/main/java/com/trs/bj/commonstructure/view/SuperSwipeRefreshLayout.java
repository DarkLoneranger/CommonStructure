...
public class SuperSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private SuperSwipeRefreshLayout.OnChildScrollUpCallback mChildScrollUpCallback;
     ...
     * gesture.
     */
    public void setOnRefreshListener(SuperSwipeRefreshLayout.OnRefreshListener listener) {
        mListener = listener;
    }
...
/*        if (android.os.Build.VERSION.SDK_INT >= 11) {
    ...
    /**
     * Set a callback to override {@link SuperSwipeRefreshLayout#canChildScrollUp()} method. Non-null
     * callback will return the value provided by the callback and ignore all internal logic.
     *
     * @param callback Callback that should be called when canChildScrollUp() is called.
     */
    public void setOnChildScrollUpCallback(@Nullable SuperSwipeRefreshLayout.OnChildScrollUpCallback callback) {
    ...
    /**
     * Classes that wish to override {@link SuperSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SuperSwipeRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(SuperSwipeRefreshLayout parent, @Nullable View child);
    }
}
